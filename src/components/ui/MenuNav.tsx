...
export const MenuNav: React.FC = () => {
  ...
  return (
    <div
      ref={menuRef}
      className={`sticky w-full  mx-auto md:w-fit backdrop-blur-2xl top-[80px]  md:mb-10 py-3 px-4 z-20 transition-all duration-300 border border-primary-foreground/10 rounded-full grid place-items-center justify-items-center`}
    >
